...
```php
    ...
    $app->route('/mia-auth/recovery-with-code', [\Mia\Mail\Handler\SendgridHandler::class, Mia\Auth\Handler\Recovery\RecoveryWithCodeHandler::class], ['GET', 'POST', 'OPTIONS', 'HEAD'], 'mia_auth.recovery-with-code');
    ...
    $app->route('/mia-auth/new-password-with-code', [\Mia\Mail\Handler\SendgridHandler::class, Mia\Auth\Handler\Recovery\NewPasswordWithCodeHandler::class], ['GET', 'POST', 'OPTIONS', 'HEAD'], 'mia_auth.new-password-with-code');
    ...
    $app->route('/user/remove/{id}', [\Mia\Auth\Handler\AuthHandler::class, new \Mia\Auth\Middleware\MiaRoleAuthMiddleware([MIAUser::ROLE_ADMIN]), \Mia\Auth\Handler\User\RemoveHandler::class], ['GET', 'DELETE', 'OPTIONS', 'HEAD'], 'user.remove');
```
